...
/**
 * Red pointer compass skin - dramatic red styling with black background
 */
public class RedPointerCompassFragment extends CompassSkinFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_red_pointer_compass, container, false);
