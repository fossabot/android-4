        ...
        try {
            ...
            if (id == R.id.action_open_web) {
                ...
                try {
                    ...
                    Intent i = new Intent(this, com.trigpointinguk.android.common.WebViewActivity.class);
                    i.putExtra(com.trigpointinguk.android.common.WebViewActivity.EXTRA_URL, url);
                    startActivity(i);
                } catch (Exception e) {
